...
SIGNAL \inst2|count\ : std_logic_vector(0 TO 3);
...
-- Equation(s):
-- \inst3|LessThan0~0_combout\ = (!\inst3|s_divCounter\(16) & (!\inst3|s_divCounter\(11) & (!\inst3|s_divCounter\(24) & !\inst3|s_divCounter\(18))))
...
-- Equation(s):
-- \inst3|LessThan0~1_combout\ = (\inst3|clkOut~3_combout\ & (\inst3|LessThan0~0_combout\ & ((!\inst3|s_divCounter\(6)) # (!\inst3|clkOut~1_combout\))))
...
-- Equation(s):
-- \inst3|LessThan0~2_combout\ = (((!\inst3|s_divCounter\(15)) # (!\inst3|s_divCounter\(14))) # (!\inst3|s_divCounter\(13))) # (!\inst3|s_divCounter\(12))
...
-- Equation(s):
-- \inst3|LessThan0~3_combout\ = (!\inst3|s_divCounter\(18) & (!\inst3|s_divCounter\(24) & (!\inst3|s_divCounter\(16) & \inst3|LessThan0~2_combout\)))
...
-- Equation(s):
-- \inst3|clkOut~2_combout\ = (\inst3|s_divCounter\(12) & (\inst3|s_divCounter\(14) & (!\inst3|s_divCounter\(6) & \inst3|s_divCounter\(13))))
...
-- Equation(s):
-- \inst3|clkOut~5_combout\ = (\inst3|s_divCounter\(11) & (!\inst3|s_divCounter\(15) & (!\inst3|s_divCounter\(17) & \inst3|s_divCounter\(16))))
...
-- Equation(s):
-- \inst3|clkOut~6_combout\ = (!\inst3|s_divCounter\(25) & (!\inst3|s_divCounter\(23) & (\inst3|s_divCounter\(24) & \inst3|clkOut~5_combout\)))
...
-- Equation(s):
-- \inst3|clkOut~7_combout\ = (\inst3|s_divCounter\(18) & (\inst3|clkOut~4_combout\ & (\inst3|clkOut~3_combout\ & \inst3|clkOut~6_combout\)))
...
-- Equation(s):
-- \inst2|count~0_combout\ = (!\SW[0]~input_o\ & !\inst2|count\(3))
...
-- Equation(s):
-- \inst2|count~1_combout\ = (!\SW[0]~input_o\ & (\inst2|count\(2) $ (\inst2|count\(3))))
...
-- Equation(s):
-- \inst2|count~2_combout\ = (!\SW[0]~input_o\ & (\inst2|count\(1) $ (((\inst2|count\(2) & \inst2|count\(3))))))
...
-- Equation(s):
-- \inst2|count~3_combout\ = (!\inst2|count\(1)) # (!\inst2|count\(3))
...
-- Equation(s):
-- \inst2|count~4_combout\ = (!\SW[0]~input_o\ & (\inst2|count\(0) $ (((\inst2|count\(2) & !\inst2|count~3_combout\)))))
...
-- Equation(s):
-- \inst|Mux0~0_combout\ = (\inst2|count\(0)) # ((\inst2|count\(2) & (\inst2|count\(3) & \inst2|count\(1))))
...
-- Equation(s):
-- \inst|Mux1~0_combout\ = (\inst2|count\(0)) # ((\inst2|count\(2) & (!\inst2|count\(3) & \inst2|count\(1))))
...
-- Equation(s):
-- \inst|Mux2~0_combout\ = (\inst2|count\(0)) # ((!\inst2|count\(2) & (\inst2|count\(3) & \inst2|count\(1))))
...
-- Equation(s):
-- \inst|Mux3~0_combout\ = (\inst2|count\(0)) # ((!\inst2|count\(2) & (!\inst2|count\(3) & \inst2|count\(1))))
...
-- Equation(s):
-- \inst|Mux4~0_combout\ = (\inst2|count\(0)) # ((\inst2|count\(2) & (\inst2|count\(3) & !\inst2|count\(1))))
...
-- Equation(s):
-- \inst|Mux5~0_combout\ = (\inst2|count\(0)) # ((\inst2|count\(2) & (!\inst2|count\(3) & !\inst2|count\(1))))
...
-- Equation(s):
-- \inst|Mux6~0_combout\ = (\inst2|count\(0)) # ((!\inst2|count\(2) & (\inst2|count\(3) & !\inst2|count\(1))))
...
-- Equation(s):
-- \inst|Mux7~0_combout\ = (!\inst2|count\(0) & ((\inst2|count\(2)) # ((\inst2|count\(3)) # (\inst2|count\(1)))))
